...
import com.example.sxd.thanksgivinghall.supplier.SupplierDetailModelImpl;
...
public class SupplierDetailPresenterImpl extends BasePresenterImpl implements SupplierDetailContract.Presenter{
    ...
    public void request(String companyid) {
        this.mModel.request(companyid, new ResultListener<SupplierEntity>() {
            @Override
            public void onStart() {
            }
            ...
            @Override
            public void onSuccess(SupplierEntity data) {
                if (data != null) {
