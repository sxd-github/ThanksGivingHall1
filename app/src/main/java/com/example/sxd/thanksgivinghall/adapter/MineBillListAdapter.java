...
public class MineBillListAdapter extends BaseQuickAdapter<MineBillListEntity.Data, BaseViewHolder> {

    private MineBillListAdapter myAdapter;

    public MineBillListAdapter(@LayoutRes int layoutResId, @Nullable List<MineBillListEntity.Data> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, MineBillListEntity.Data item) {

        helper.setText(R.id.income,"收入："+item.getSumprice())
                .setText(R.id.goods_buy,"出售："+item.getGoods())
                .setText(R.id.bill_time,"日期："+item.getDate());
